...
main() {
  ...
  echo "  bin/dot link all"
  echo ""
  echo "  # Install Homebrew packages"
  echo "  bin/dot brew bundle"
  echo ""
  echo "  # Set up git identity"
  echo "  bin/dot git setup"
  echo ""
  echo "  # Configure macOS defaults & install keyboard layouts"
  echo "  bin/dot macos defaults"
  echo "  bin/dot macos keyboard"
  echo ""
  echo "  # Set up shell"
